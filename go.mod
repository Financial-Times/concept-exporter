...
require (
	...
	github.com/Financial-Times/api-endpoint v1.0.0 // indirect
	...
	github.com/Financial-Times/kafka-client-go v0.0.0-20181214120216-c3a1941e42a4 // indirect
...
replace gopkg.in/stretchr/testify.v1 => github.com/stretchr/testify v1.3.0
